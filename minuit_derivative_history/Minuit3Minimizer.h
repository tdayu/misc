...
// Header file for class Minuit3Minimizer

#ifndef ROOT_Minuit2_Minuit3Minimizer
#define ROOT_Minuit2_Minuit3Minimizer
...
/**
   Minuit3Minimizer class implementing the ROOT::Math::Minimizer interface for
   ...
   @ingroup Minuit
*/
class Minuit3Minimizer : public ROOT::Math::Minimizer {

public:
   /**
      Default constructor
   */
   Minuit3Minimizer(ROOT::Minuit2::EMinimizerType type = ROOT::Minuit2::kMigrad);

   /**
      Constructor with a char (used by PM)
   */
   Minuit3Minimizer(const char *type);

   /**
      Destructor (no operations)
   */
   virtual ~Minuit3Minimizer();
...
private:
   ...
   /**
      Copy constructor
   */
   Minuit3Minimizer(const Minuit3Minimizer &);

   /**
      Assignment operator
   */
   Minuit3Minimizer &operator=(const Minuit3Minimizer &rhs);
...
#endif /* ROOT_Minuit2_Minuit3Minimizer */
